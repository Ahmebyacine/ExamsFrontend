...
import AnswerViewArabic from './AnswerViewArabic';
import AnswerViewLatino from './AnswerViewLatino';
...
const ExamAnswerDocument = ({ exam ,year, level, material, trimester  }) => {
...
export default ExamAnswerDocument;